...
def plot_tables(bias_score_map: dict) -> None:
    categories = [
        "age",
        "disability_status",
        "gender_identity",
    ...
    for category in categories:
        ambiguous_multiple_choice_gpt3_5 = round(bias_score_map[f"{category}_ambiguous_multiple_choice_gpt3-5"], 3)
        ambiguous_fill_blank_gpt3_5 = round(bias_score_map[f"{category}_ambiguous_fill_blank_gpt3-5"], 3)
        ambiguous_short_answer_gpt3_5 = round(bias_score_map[f"{category}_ambiguous_short_answer_gpt3-5"], 3)
        ambiguous_multiple_choice_gpt4o = round(bias_score_map[f"{category}_ambiguous_multiple_choice_gpt4o"], 3)
        ambiguous_fill_blank_gpt4o = round(bias_score_map[f"{category}_ambiguous_fill_blank_gpt4o"], 3)
        ambiguous_short_answer_gpt4o = round(bias_score_map[f"{category}_ambiguous_short_answer_gpt4o"], 3)

        disambiguated_multiple_choice_gpt3_5 = round(bias_score_map[f"{category}_disambiguated_multiple_choice_gpt3-5"], 3)
        disambiguated_fill_blank_gpt3_5 = round(bias_score_map[f"{category}_disambiguated_fill_blank_gpt3-5"], 3)
        disambiguated_short_answer_gpt3_5 = round(bias_score_map[f"{category}_disambiguated_short_answer_gpt3-5"], 3)
        disambiguated_multiple_choice_gpt4o = round(bias_score_map[f"{category}_disambiguated_multiple_choice_gpt4o"], 3)
        disambiguated_fill_blank_gpt4o = round(bias_score_map[f"{category}_disambiguated_fill_blank_gpt4o"], 3)
        disambiguated_short_answer_gpt4o = round(bias_score_map[f"{category}_disambiguated_short_answer_gpt4o"], 3)
    ...
    fig, ambiguous_ax = plt.subplots(figsize=(12, 6))  # figsize=(12, 6)
